...
# First we get the listing tables for nasdaq and sandp from this database
listing_database = '../../data/external/us_listings.db'
# Then we query the listed symbols and place their data in the raw tables database
